...
#' @param year_th Thai Buddhist year (e.g. 2567). Used as a standalone mode for `/all`,
...
#'   Can be combined with `year_th` as a filter. Default: `FALSE`.
#' @param api_key API key (if required)
#'
#' @return A data.frame of yearly production index records
#' @export
#'
#' @examples
...
# ---------------------------------------------------------------------------
.piy_fetch_all <- function(path, base_params, api_key) {
